...
# Actual data: http://py4e-data.dr-chuck.net/comments_913543.json (Sum ends with 76)
...
#  json2.py. You might also want to look at geoxml.py to see how to prompt for
#   a URL and retrieve data from a URL.
#
# Sample Execution
#
# $ python3 solution.py
